...
class YoutubeScheduledPost extends StatefulWidget {
  const YoutubeScheduledPost({super.key});

  @override
  State<YoutubeScheduledPost> createState() => _YoutubeScheduledPostState();
}

class _YoutubeScheduledPostState extends State<YoutubeScheduledPost> {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          //         ),
          //       ),
          semicontroller.formattedDateyou.value,
