...
class reditScheduledPost extends StatefulWidget {
  const reditScheduledPost({super.key});

  @override
  State<reditScheduledPost> createState() => _reditScheduledPostState();
}

class _reditScheduledPostState extends State<reditScheduledPost> {
