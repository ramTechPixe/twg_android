...
class PinterestScheduledPost extends StatefulWidget {
  const PinterestScheduledPost({super.key});

  @override
  State<PinterestScheduledPost> createState() => _PinterestScheduledPostState();
}

class _PinterestScheduledPostState extends State<PinterestScheduledPost> {
