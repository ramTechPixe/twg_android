...
class TumblrScheduledPost extends StatefulWidget {
  const TumblrScheduledPost({super.key});

  @override
  State<TumblrScheduledPost> createState() => _TumblrScheduledPostState();
}

class _TumblrScheduledPostState extends State<TumblrScheduledPost> {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Text(
              semicontroller.tumblerScheduledPostStatus.value == "1"
                  ? "Published"
                  : semicontroller.tumblerScheduledPostStatus.value == "2"
                      ? "Scheduled"
                      : "Unpublished",
              style: GoogleFonts.poppins(
