...
class InstaScheduledPost extends StatefulWidget {
  const InstaScheduledPost({super.key});

  @override
  State<InstaScheduledPost> createState() => _InstaScheduledPostState();
}

class _InstaScheduledPostState extends State<InstaScheduledPost> {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          //         ),
          //       ),
          semicontroller.formattedDateinsta.value,
