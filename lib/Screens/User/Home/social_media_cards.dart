...
class _SocialMediaCardsState extends State<SocialMediaCards> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => dashboardController.networksCountList.isEmpty ||
            dashboardController.networksCountList == null
        ? SizedBox()
        : Wrap(
            spacing: 20,
            runSpacing: 10,
            children: [
              for (int i = 0;
                  i < dashboardController.networksCountList.length;
                  i++)
                Container(
                  ...
                  child: Column(
                    children: [
                                                    ...
                                                    : dashboardController
                                                        ...
                                                        : dashboardController
                                                            ...
                                                            : dashboardController
                                                                ...
                                                                : "assets/images/${dashboardController.networksCountList[i].keys.first}_images.png",
                      ...
                      Text(
                        dashboardController
                                .networksCountList[i].values.first.isEmpty
                            ? "0"
                          ...
                          children: [
                            ...
                            Text(
                              dashboardController
                                  ...
                                  ? "0"
                                  : dashboardController.networksCountList[i]
                                      .values.first, // Display completed posts
                              style: GoogleFonts.poppins(
                                color: Kwhite,
                                fontSize: 11.sp,
                                fontWeight: kFW400,
