  ...
  void toggleautoPostSwitch(bool value) async {
    if (isautopostingSwitched == false) {
      ...
      setState(() {
        ...
        UserSimplePreferences.pinterestStatus(pinterestStatus: true);
        //  _isfbExpandCard = true;
      });
    } else {
      setState(() {
        isautopostingSwitched = false;
        UserSimplePreferences.pinterestStatus(pinterestStatus: false);
                    ...
                    children: [
                      ...
                      Transform.scale(
                        ...
                        child: Switch(
                          ...
                          value: UserSimplePreferences.getPinterestStatus() ??
