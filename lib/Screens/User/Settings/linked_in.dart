...
class Linkedinn extends StatefulWidget {
  const Linkedinn({super.key});

  @override
  State<Linkedinn> createState() => _LinkedinnState();
}

class _LinkedinnState extends State<Linkedinn> {
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Enable this button, if you want to automatically post your new content to LinkedIn.",
                    style: GoogleFonts.poppins(
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Posting content to your chosen LinkedIn personal account requires you to grant extended permissions. If you want to use this feature you should grant the extended permissions now.",
                    style: GoogleFonts.poppins(
                        fontSize: 11.sp, color: kblack, fontWeight: kFW400),
                  ),
                  SizedBox(
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        "LinkedIn APP Method(Recommnended)",
          ...
          Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Select each of the users that you want to automatically post to LinkedIn when a new post is published and enter  ' , ' to select.",
                    style: GoogleFonts.poppins(
